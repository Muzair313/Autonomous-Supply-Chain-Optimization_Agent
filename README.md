# Agentic AI for Supply Chain Optimization (M5 Dataset)

Designed and developed a multi-agent LLM-based supply chain system to automate decentralized decision-making and reduce the Bullwhip Effect. Built a forecasting backbone using the M5 Forecasting Accuracy dataset to model real-world demand patterns, followed by a simulation engine representing inventory flow across supply chain entities (Retailer, Distributor, Manufacturer).
